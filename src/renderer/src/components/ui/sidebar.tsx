...
function Sidebar({
  ...
  return (
    <div
      ...
      data-overlay-expanded={overlayExpanded}
    ...
    >
      ...
      <div
        ...
        style={overlayExpanded ? { width: 0 } : undefined}
        className={cn(
...
function SidebarGroupAction({
  ...
  return useRender({
    ...
    props: mergeProps<'button'>(
      {
        className: cn(
          'absolute right-1 flex aspect-square w-5 items-center justify-center rounded-md p-0 text-sidebar-foreground ring-sidebar-ring outline-hidden transition-transform group-data-[collapsible=icon]:hidden after:absolute after:-inset-2 hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 md:after:hidden [&>svg]:size-4 [&>svg]:shrink-0',
          className,
        ),
      },
      props,
